...
![Animal health early warning](resources/0_animal_public_health_structure.png)
...
![Tracker program structure](resources/tracker_structure.png)
...
### Stage 1: Epidemiology [repeatable]
...
![Surveillance and infection source](resources/epidemiology_surveillance_infection_source.png)
...
![Sample ID](resources/laboratory_sample_identification.png)
...
![dashboard3](resources/dashboard_3.png)
